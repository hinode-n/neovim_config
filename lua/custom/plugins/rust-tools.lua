local function on_attach(client, buffer)
	...
	vim.keymap.set("n", "<leader>gr", '<cmd>Telescope lsp_references<CR>', keymap_opts)
	vim.keymap.set("n", "g0", vim.lsp.buf.document_symbol, keymap_opts)
	vim.keymap.set("n", "gW", vim.lsp.buf.workspace_symbol, keymap_opts)
	vim.keymap.set("n", "<leader>gd", '<cmd>Telescope lsp_definitions<CR>', keymap_opts)
	vim.keymap.set("n", "<leader>gt", '<cmd>Telescope lsp_type_definitions<CR>', keymap_opts)
